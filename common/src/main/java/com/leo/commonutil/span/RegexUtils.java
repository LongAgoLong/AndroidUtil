...
public class RegexUtils {
    ...
    public static final String Html = "(https|http)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]";
     ...
     * @return
     */
    public static SpannableString highLightNumber(String source, @ColorInt int color) {
    ...
    public static CstMovementMethod highLightAndClickHtml(final Context context, TextView textView, String source, String replaceStr,
        ...
        while (matcher.find()) {
            final String html = matcher.group();
            int start = matcher.start();
